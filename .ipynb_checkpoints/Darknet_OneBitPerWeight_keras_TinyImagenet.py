...
NAME = "Darknet_OnebitperWeight_TinyImagenet{}".format(datetime.now().strftime("%Y%m%d"))
...
model = darknet19_binary(input_shape=input_shape,num_classes=200)
...
model.save_weights(ModelsPath+'Final_weights_darknet'+WhichDataSet+'one-bit-per-weight_tinyImagNet.ckpt')
...
#In8
#save the weigts used for updating
#model.save_weights(ModelsPath+'Final_weights_'+WhichDataSet+'one-bit-per-weight_tinyImagNet.h5')
